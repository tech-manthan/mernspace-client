...
const ToppingList = ({
  ...
  handleToppingToggle: (topping: Topping, checked: boolean) => void;
}) => {
  ...
  return (
    <section className="w-full max-w-sm">
      <h4 className="text-base font-semibold">Extra Toppings</h4>
                ...
                >
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleToppingToggle(topping, checked as boolean)
                    }
                    className="hidden"
                  />
